$_mod.def("/mocha-puppeteer$0.13.0/lib/pages/test-page/run-tests", function(require, exports, module, __filename, __dirname) { const { mocha, Mocha, WebSocket, superagent, location } = window
